...
contract MyToken is StandardToken, DetailedERC20 {
    ...
    constructor() public DetailedERC20("My token", "FMT", 18){
    ...
    function transferFrom(address _from, address _to, uint _value) public notFrozen(_from) returns (bool){
        return super.transferFrom(_from, _to, _value);
    }

    function transfer(address _to, uint _value) public notFrozen(msg.sender) returns (bool){
        require(m_freeze_info[msg.sender] <= now);
